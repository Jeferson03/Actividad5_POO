...
public class VentanaPrincipal extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(campoNota5, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
    ...
    private void calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcularActionPerformed
        ...
        try {
            ...
            double promedio1 = nota.promedioNotasIngresadas();
            double desviacion1 = nota.desviacionEstandar();
            double mayor1 = nota.mayorNota();
            double menor1 = nota.menorNota();
            promedio.setText("Promedio: " + String.valueOf(promedio1));
            desviacion.setText("Desviacion estándar: " + String.valueOf(desviacion1));
            menor.setText("Menor nota: " + String.valueOf(menor1));
            mayor.setText("Mayor nota: " + String.valueOf(mayor1));
        } catch (Exception e) {
            error = true;
        }finally {
            if (error == true){
